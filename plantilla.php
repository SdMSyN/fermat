...
<head>
	...
	<?php
		...
		$optTables='<ul class="nav nav-sidebar">';
		while($rowGetTables = $resGetTables->fetch_assoc()){
			if($liga == $rowGetTables['name'])
				$optTables.='<li class="active"><a href="form_add_team.php?liga='.$rowGetTables['name'].'">'.$rowGetTables['name'].'</a></li>';
			else
				$optTables.='<li><a href="form_add_team.php?liga='.$rowGetTables['name'].'">'.$rowGetTables['name'].'</a></li>';
		}
		$optTables.='</ul>';
